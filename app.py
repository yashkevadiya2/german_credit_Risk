# 1 good(lower Risk) and o is bad(Higher Risk)
...
st.write("Enter applicant information to preduct if the credit risk is good or bad")
...
if st.button("Predict Risk"):
    ...
    if pred ==1 :
        ...
        st.error("The predicted credit risk id : **BAD**")  